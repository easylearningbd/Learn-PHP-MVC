...
<head>
  ...
  <title>Advanced PHP OOP Project</title>
<style>
...
.postcontent{width: 770px; border-right: 1px solid #ddd; float: left; margin-right: 20px; padding-right: 20px; overflow:hidden;}
...
.desc{}
.desc p{line-height: 24px; text-decoration: justify;}




.serchoption{border-bottom: 2px dashed #3399ff; margin-bottom: 15px;padding-bottom: 10px; overflow: hidden;}
...
.widget ul li a{ background: #77d25b; none repeat scroll 0 0; color: #fff; display:block;
margin-bottom: 1px;padding: 5px;text-decoration: none; }
.widget ul li a:hover{background: #b3f59e}
