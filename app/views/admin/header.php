...
.adminleft{border-right: 1px solid #ddd;
float: left;
margin-right: 10px;
padding-right: 10px;
width: 220px;
...
.widget h3{background: #77d25b none repeat scroll 0 0;
...
.widget ul li a{ background: #ddd none repeat scroll 0 0;
...
input[type="text"] {border:1px solid #ddd;margin-bottom:5px;padding:5px;width:328px;font-size:16px}
.cat{border:1px solid #ddd;margin-bottom:5px;padding:5px;width:328px;font-size:16px; cursor: pointer;}
